...
import { Stethoscope, Loader2, Github, Mail } from 'lucide-react'
        ...
        <div className="min-h-screen gradient-soft flex flex-col items-center justify-center px-4 py-12">
            ...
            <div className="w-full max-w-md animate-slide-up bg-white rounded-2xl border border-[#E2E8F0] p-8 shadow-sm">
                <div className="text-center mb-8">
                    <h1 className="text-2xl font-black text-[#0F172A] mb-2 tracking-tight">Bem-vindo de volta</h1>
                    <p className="text-[#64748B] text-sm font-medium">Faça login para gerenciar suas páginas</p>
                </div>
                ...
                <form onSubmit={handleLogin} className="space-y-4">
                    ...
                    <div className="space-y-2">
                        <div className="flex items-center justify-between pl-1">
                            <label className="text-xs font-bold text-[#0F172A] uppercase tracking-wider">Senha</label>
                            <Link href="/recuperar-senha" title="Em breve" className="text-xs font-bold text-[#0D7C66] hover:underline">
                                Esqueceu?
                            </Link>
                        </div>
                        <input
                ...
                <div className="mt-8 pt-8 border-t border-[#F1F5F9] text-center">
                    <p className="text-sm font-medium text-[#64748B]">
                        Não tem uma conta?{' '}
                        <Link href="/cadastro" className="text-[#0D7C66] font-bold hover:underline">
